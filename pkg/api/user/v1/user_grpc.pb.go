...
const (
	...
	UserService_Get_FullMethodName    = "/api.user.v1.UserService/Get"
	UserService_Update_FullMethodName = "/api.user.v1.UserService/Update"
	UserService_Delete_FullMethodName = "/api.user.v1.UserService/Delete"
)
